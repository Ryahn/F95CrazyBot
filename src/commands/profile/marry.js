...
module.exports = {
	...
	async execute(interaction) {
		...
		const ryahn = await interaction.client.users.fetch('72884988374167552');
		...
		if (target == ryahn) return await interaction.editReply({ content: "Are you trying to steal my man?!", ephemeral: true });
