...
module.exports = {
    ...
    async execute(interaction) {
        ...
        const embed = new EmbedBuilder()
            ...
            .addFields(
                // { name: 'How it started...', value: "I actually decided to code my own bot because I felt like 'Ugh pay2win I dont like that' sooooo I decided to do it free then. Yes, this bot is completely free, but I have to pay to maintain it tho lol\nThe first few lines of code of `cyberpunkxxx.` were written in Python with discord.py, but sadly this library isn't maintained anymore so I had to switch to `Discord.js` which is obv written in JavaScript. Uh yeah, a date..  it was the 12th August 2020 when I started this project. How time has passed\nEnough bs, time for important information!", inline: false },
                ...
                { name: "Code", value: "https://github.com/eckigerluca/cyberpunkxxx", inline: true },
